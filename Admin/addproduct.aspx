...
<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" ValidateRequest="false" AutoEventWireup="true" CodeFile="addproduct.aspx.cs" Inherits="Admin_Default" %>
...
<asp:Content ID="body" ContentPlaceHolderID="body" runat="Server">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea runat="server" id="proDesc" class="form-control" placeholder="Description" rows="8"></textarea>
                    </div>

                    <div class="mb-3">
                        <label for="proPrice" class="form-label text-dark font-weight-bolder">Product Price</label>
                        <input runat="server" class="form-control" id="proPrice" placeholder="Price"/>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input runat="server" class="form-control" id="proCost" placeholder="Cost Price"/>
                    </div>
                    ...
                    <div class="mb-3">
                        <label for="proQty" class="form-label text-dark font-weight-bolder">Product Quantity</label><abbr style="font-size:12px;"> (nos)</abbr>
                    ...
                    <asp:Button runat="server" ID="btnsub" OnClick="btnsub_Click" OnClientClick="return valid()" Text="Add"  CssClass="btn btn-success"></asp:Button>
    ...
    <script type="text/javascript" language="javascript">
        ...
        {            
            ...
            else if(pimg1.value == "" && pimg2.value == "" && pimg3.value == "")
            {
                return swalalert("Please Enter At Least One Image", "", "error", pimg1);
            }
            else
            {
                return true;
